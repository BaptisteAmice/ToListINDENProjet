...
export class TitlesService {
    ...
    async create(name : string, type : TitleType, description : string, releaseDateStart : Date, releaseDateEnd : Date, country : string, episodeCount : number): Promise<Title> {
        const title = new Title(name,type, description, releaseDateStart, releaseDateEnd, country, episodeCount);
